...
(function (g) {
  'use strict';
  var L = {};
  L.VERSION = 'Lettres v1 · 25/09/2026';
  ...
  */
  ...
  L.verifier = function (texte, contexte) {
    ...
    blocs.forEach(function (b) {
      ...
      if (/festivali[eè]re?s?/i.test(texteSeul)) e(b.n, '« festivaliers » : utilisez « participants ».');
      else if (/\bfestivals?\b/i.test(texteSeul)) e(b.n, '« Festival » : utilisez « Célébration » (terme officiel).');
